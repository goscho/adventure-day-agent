...
functions = [
        {
        ...
        },
         {
            ...
            "function": {
                ...
                "description": "Gets the actors of a movie",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "title": {
...
async def ask_question(ask: Ask):
    ...
    sysPromt = "Answer the question of the user and use the tools available to you. "
    
    if(ask.type == QuestionType.estimation):
        sysPromt += "Provide short answer, no bs."
    elif(ask.type == QuestionType.multiple_choice):
        sysPromt += "no option label, no bs"
    elif(ask.type == QuestionType.true_or_false):
        sysPromt += "Respond with true or false, no bs"
